...
var Medusa = require('@medusajs/medusa-js');
...
var Medusa__default = /*#__PURE__*/_interopDefaultLegacy(Medusa);
...
var MedusaContext = /*#__PURE__*/React__default["default"].createContext(null);
var useMedusa = function useMedusa() {
  var context = React__default["default"].useContext(MedusaContext);
...
var MedusaProvider = function MedusaProvider(_ref) {
  ...
  var medusaClient = new Medusa__default["default"]({
    baseUrl: baseUrl,
    maxRetries: 0,
    apiKey: apiKey
  });
  return React__default["default"].createElement(reactQuery.QueryClientProvider, _extends({}, queryClientProviderProps), React__default["default"].createElement(MedusaContext.Provider, {
    value: {
      client: medusaClient
    }
  }, children));
...
var _excluded$I = ["variant", "region", "includeTaxes"],
...
var SessionCartContext = /*#__PURE__*/React__default["default"].createContext(null);
var ACTION_TYPES;
...
var SessionCartProvider = function SessionCartProvider(_ref) {
  ...
  var _React$useReducer = React__default["default"].useReducer(reducer, JSON.parse(saved)),
  ...
  return React__default["default"].createElement(SessionCartContext.Provider, {
...
var useShippingOptions = function useShippingOptions(query, options) {
  ...
  var _useQuery = reactQuery.useQuery(shippingOptionKey.list(query), /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
var useCartShippingOptions = function useCartShippingOptions(cartId, options) {
  ...
  var _useQuery2 = reactQuery.useQuery(shippingOptionKey.cart(cartId), /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
...
var useUpdateMe = function useUpdateMe(options) {
  ...
  return reactQuery.useMutation(function (_ref) {
    var data = _objectWithoutPropertiesLoose(_ref, _excluded$z);
...
var useUpdateLineItem = function useUpdateLineItem(cartId, options) {
  ...
  return reactQuery.useMutation(function (_ref) {
    var lineId = _ref.lineId,
        data = _objectWithoutPropertiesLoose(_ref, _excluded$x);
...
var CartContext = /*#__PURE__*/React__default["default"].createContext(null);
var useCart = function useCart() {
  var context = React__default["default"].useContext(CartContext);
...
var CartProvider = function CartProvider(_ref) {
  ...
  return React__default["default"].createElement(CartContext.Provider, {
    value: {
      cart: cart,
      setCart: setCart,
...
var useAdminUpdateClaim = function useAdminUpdateClaim(orderId, options) {
  ...
  return reactQuery.useMutation(function (_ref) {
    var claim_id = _ref.claim_id,
        payload = _objectWithoutPropertiesLoose(_ref, _excluded$s);
...
var useAdminUpdateCurrency = function useAdminUpdateCurrency(code, options) {
  var _useMedusa = useMedusa(),
      client = _useMedusa.client;

  var queryClient = reactQuery.useQueryClient();
  return reactQuery.useMutation(function (payload) {
    return client.admin.currencies.update(code, payload);
  }, buildOptions(queryClient, [adminCurrenciesKeys.lists(), adminCurrenciesKeys.detail(code)], options));
};

var _excluded$q = ["data"];
var ADMIN_CURRENCIES_QUERY_KEY = "admin_currencies";
var adminCurrenciesKeys = /*#__PURE__*/queryKeysFactory(ADMIN_CURRENCIES_QUERY_KEY);
var useAdminCurrencies = function useAdminCurrencies(query, options) {
  var _useMedusa = useMedusa(),
      client = _useMedusa.client;

  var _useQuery = reactQuery.useQuery(adminCurrenciesKeys.list(query), function () {
    return client.admin.currencies.list(query);
  }, options),
      data = _useQuery.data,
...
var useAdminSalesChannel = function useAdminSalesChannel(id, options) {
  ...
  var _useQuery = reactQuery.useQuery(adminSalesChannelsKeys.detail(id), function () {
...
var useAdminSalesChannels = function useAdminSalesChannels(query, options) {
  ...
  var _useQuery2 = reactQuery.useQuery(adminSalesChannelsKeys.list(query), function () {
...
exports.adminCurrenciesKeys = adminCurrenciesKeys;
...
exports.adminSalesChannelsKeys = adminSalesChannelsKeys;
...
exports.useAdminAddProductsToCollection = useAdminAddProductsToCollection;
exports.useAdminAddProductsToSalesChannel = useAdminAddProductsToSalesChannel;
...
exports.useAdminCreateSalesChannel = useAdminCreateSalesChannel;
...
exports.useAdminCurrencies = useAdminCurrencies;
...
exports.useAdminDeleteProductsFromSalesChannel = useAdminDeleteProductsFromSalesChannel;
exports.useAdminDeleteRegion = useAdminDeleteRegion;
exports.useAdminDeleteReturnReason = useAdminDeleteReturnReason;
exports.useAdminDeleteSalesChannel = useAdminDeleteSalesChannel;
...
exports.useAdminRemoveProductsFromCollection = useAdminRemoveProductsFromCollection;
...
exports.useAdminSalesChannel = useAdminSalesChannel;
exports.useAdminSalesChannels = useAdminSalesChannels;
...
exports.useAdminUpdateCurrency = useAdminUpdateCurrency;
...
exports.useAdminUpdateSalesChannel = useAdminUpdateSalesChannel;
